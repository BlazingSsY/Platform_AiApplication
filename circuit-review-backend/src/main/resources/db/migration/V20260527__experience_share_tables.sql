...
CREATE TABLE "public"."sjjyfx_experience_share" (
    ...
    "contributor" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL,
    "organization" varchar(500) COLLATE "pg_catalog"."default" DEFAULT NULL,
    "contact" varchar(500) COLLATE "pg_catalog"."default" DEFAULT NULL,
