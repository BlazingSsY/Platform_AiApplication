 ...
 * @date 2025-01-07
 */
public interface CircuitReviewRuleMapper extends BaseMapper<CircuitReviewRule> {
     ...
     * @return 删除的记录数
     */
    @Delete("DELETE FROM dlsc_rule WHERE comments = #{comments}")
     ...
     * @return 删除的记录数
     */
    @Delete("DELETE FROM dlsc_rule WHERE id = #{id}")
