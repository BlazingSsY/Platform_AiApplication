...
@TableName(value = "dlsc_file_version", autoResultMap = true)
@Data
@JsonInclude(JsonInclude.Include.NON_NULL)
@Schema(description = "电路图文件版本模型")
@ToString(callSuper = true)
@Accessors(chain = true)
public class CircuitFileVersion extends IdBaseModel implements Serializable {
