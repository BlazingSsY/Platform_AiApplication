    ...
    <div class="feedback-container">
      <div class="leftCont">
        ...
        <div class="content" style="display: flex;">
         <span class="labelTitle">经验分享内容：</span> 
         <div v-html="localData.content.replace(/\n/g, '<br>')" style="white-space: pre-wrap; flex: 1;" />
        </div>
        <div class="content">
        ...
        >
          ...
          >
            ...
            <!-- <div v-if="replyItem.refAnswer&&replyItem.refAnswer.reply" class="refAnswer">
              <el-tooltip :content="replyItem.refAnswer.reply" placement="bottom" effect="light" class="refAnswertooltip" popper-class="refAnswertooltip">
                <div class="content"> 
                    <div class="text"> 
                        {{ replyItem.refAnswer.reply }}
                    </div>
...
import { getReplies,delReply } from '../api'
