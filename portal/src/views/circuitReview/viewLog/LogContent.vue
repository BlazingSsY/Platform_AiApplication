<template>
  <div class="log-content">
      ...
      <div class="search-wrapper">
        <div class="search-panel">
          <el-input
            ...
            @input="onSearchInput"
          />
          <button @mousedown.prevent @click="findNext" title="下一个">↓</button>
          <button @mousedown.prevent @click="findPrev" title="上一个">↑</button>
    ...
    <div class="tableBox">
      <div class="log-editor-wrapper" :class="{ 'dark-mode': isDarkMode }">
...
const props = defineProps<{
  fetchLog: (num: number) => Promise<any>
  downloadLog: (num: number) => void
  defaultNum: number
}>()
...
const num = ref(props.defaultNum)
let matches: any[] = []
...
.log-editor-wrapper.dark-mode {
  ...
  // }
  .cm-editor .cm-activeLineBackground,
  .cm-editor.cm-focused .cm-activeLineBackground {
