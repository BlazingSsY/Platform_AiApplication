package com.starmol.sourcecodereview;

import com.starmol.sourcecodereview.constant.DeploymentTypeEnum;
...
@EnableAsync
@EnableScheduling
@EnableFeignClients(basePackages = {"com.starmol.sourcecodereview.service"})
@SpringBootApplication(scanBasePackages = "com.starmol.sourcecodereview")
@ComponentScan(value = {"com.starmol.sourcecodereview"}, nameGenerator = FullyQualifiedAnnotationBeanNameGenerator.class)
@MapperScan(basePackages = {"com.starmol.sourcecodereview.repository"})
