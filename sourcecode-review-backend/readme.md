# sourcecode-review-backend - 代码审查后端服务

## 项目简介

SourceCode Backend 是一个基于 Spring Boot 的数智平台后端服务。
...
3. 获取审查结果：    
    接口：/code/review/result/{接口1返回的reviewId}?version=2026-02-02 11:13:11
    请求方式：GET
    响应结果：
        {
            "duration": 230     // 单位秒
...
13. 任务排队信息查询
  描述: 用于查询任务排队信息
  接口：/code/review/wait/task/接口1返回的参数
  请求方式：GET
  响应参数：
        {
...
14. 审查进度查询       
  描述: 查询审查进度
  接口：/code/review/process/接口1返回的参数
  请求方式：GET
  响应参数：
        {
...
15. 获取审查的文件的代码
  描述: 用于获取审查的文件的代码
  接口：/code/review/source/code/接口1返回的参数?fileName=test.zip?offset=12-30?version=2026-02-02 11:13:11
  请求方式：GET
  响应参数：
        {
...
16. 查询代码版本列表接口
  描述: 用于获取代码文件的版本列表  
  接口:/code/review/version/list/接口1返回的参数
  请求方式:GET
  响应参数:
  {
...
接口:/code/review/recheck/detail/接口1返回的参数&version=xxxxx&&curUserRoleType=1
请求方式: GET
响应参数
    {
        version: ""，//版本
...
20.复核结果详情列表(这次先不做)
接口:/code/review/recheck/records/接口1返回的参数
请求方式:GET
请求参数:
   {
      "records":[{
...
21.复核评审结果提交
接口: /code/review/recheck/result/submit
请求方式:POST
请求参数:
    {
       "reviewId": "审查ID",
...
22.粉碎文件文件
接口:/code/review/delete/接口1返回的参数
请求方式:GET
响应参数:
    {
