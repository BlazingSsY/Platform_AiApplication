...
public class JacksonArrayTypeHandler extends AbstractJsonTypeHandler<Object> {
    ...
    public static void setObjectMapper(ObjectMapper objectMapper) {
        ...
        JacksonArrayTypeHandler.OBJECT_MAPPER = objectMapper;
    }

    @Override
    public List<Object> parse(String json) {
        try {
            return getObjectMapper().readValue(json, getObjectMapper().getTypeFactory().constructCollectionType(List.class, type));
        } catch (IOException e) {
