...
CREATE TABLE "public"."oauth_client" (
    ...
    "client_desc" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
    "logo_url" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
    ...
    "update_user" varchar(22) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
