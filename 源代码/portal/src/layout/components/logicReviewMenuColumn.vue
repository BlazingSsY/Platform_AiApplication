    ...
    <div class="menu-system">
      ...
      <transition name="slide">
        <div v-if="isExpanded" class="menu-content">
          <div :class="{ 'menu-item-home': true, actPath: actPath === `/logicReviewHome` }" @click="handleHomeClick(`/logicReviewHome`)">
          ...
          <div :class="{ 'menu-item-home': true, actPath: actPath === `/logicDocumentReview` }" @click="handleHomeClick(`/logicDocumentReview`)">
            <div class="menu-item-wrapper">
          ...
          <div :class="{ 'menu-item-home': true, actPath: actPath === `/logicRuleList` }" @click="handleHomeClick(`/logicRuleList`)">
            <div class="menu-item-wrapper">
          ...
          <div :class="{ 'menu-item-home': true, actPath: actPath === `/logicStatistics` }" @click="handleHomeClick(`/logicStatistics`)">
            <div class="menu-item-wrapper">
          ...
          <div class="menu-divider" />
          <div :class="{ 'menu-item-home': true, actPath: actPath === `/logicToolDownload` }" @click="handleHomeClick(`/logicToolDownload`)">
            <div class="menu-item-wrapper">
          ...
          <div :class="{ 'menu-item-home': true, actPath: actPath === `/logicFeedback` }" @click="handleHomeClick(`/logicFeedback`)">
            <div class="menu-item-wrapper">
              <el-icon><DataAnalysis /></el-icon>
              <span>意见反馈</span>
            </div>
          ...
          <div v-if="isAdmin || isExpert" :class="{ 'menu-item-home': true, actPath: actPath === `/logicReviewList` }" @click="handleHomeClick(`/logicReviewList`)">
            <div class="menu-item-wrapper">
          ...
          <div v-if="isAdmin" :class="{ 'menu-item-home': true, actPath: actPath === `/logicViewLog` }" @click="handleHomeClick(`/logicViewLog`)">
            <div class="menu-item-wrapper">
              <el-icon><Tickets /></el-icon>
              <span>日志查看</span>
            </div>
