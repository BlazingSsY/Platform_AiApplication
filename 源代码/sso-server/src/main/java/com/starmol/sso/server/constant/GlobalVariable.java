package com.starmol.sso.server.constant;
...
public interface GlobalVariable {
	...
	String USER_LOGIN_INFO_KEY = "userAttribute";
	...
	String REDIS_CLIENT_ROLE_KEY_PREFIX = "OAUTH:ROLE_POWER:";

	String REDIS_CLIENT_USER_ROLE_KEY_PREFIX = "OAUTH:USER_ROLE:";
	...
	String OAUTH_ERROR_URI_MSG = "got error.";
	String OAUTH_ERROR_MSG = "invalid request";

	Integer OAUTH_PASSWORD_EXPIRED_CODE = 40006;
