...
CREATE TABLE "public"."ljsc_review_result_detail" (
                                                      ...
                                                      "question_id" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL,
...
CREATE TABLE "public"."ljsc_rule" (
                                      ...
                                      "create_user" int8,
                                      "update_user" int8,
                                      "explain" varchar(1000) COLLATE "pg_catalog"."default" DEFAULT NULL
)
;
...
-- ----------------------------
CREATE INDEX IF NOT EXISTS "logic_file_minio_id_index" ON "public"."ljsc_file" USING btree (
...
-- ----------------------------
CREATE INDEX IF NOT EXISTS "logic_answer_create_date_index" ON "public"."logic_yjfk_answer" USING btree (
    "create_date" "pg_catalog"."timestamp_ops" ASC NULLS LAST
    );
CREATE INDEX IF NOT EXISTS "logic_answer_fid_index" ON "public"."logic_yjfk_answer" USING btree (
    "f_id" "pg_catalog"."int8_ops" ASC NULLS LAST
    );
CREATE INDEX IF NOT EXISTS "logic_answer_update_date_index" ON "public"."logic_yjfk_answer" USING btree (
...
-- ----------------------------
CREATE INDEX IF NOT EXISTS "logic_append_file_fid_index" ON "public"."logic_yjfk_append_file" USING btree (
    "f_id" "pg_catalog"."int8_ops" ASC NULLS LAST
    );
CREATE INDEX IF NOT EXISTS "logic_append_file_type_index" ON "public"."logic_yjfk_append_file" USING btree (
...
-- ----------------------------
CREATE INDEX IF NOT EXISTS "logic_suggestion_create_date_index" ON "public"."logic_yjfk_suggestion" USING btree (
    "create_date" "pg_catalog"."timestamp_ops" ASC NULLS LAST
    );
CREATE INDEX IF NOT EXISTS "logic_suggestion_update_date_index" ON "public"."logic_yjfk_suggestion" USING btree (
    "update_date" "pg_catalog"."timestamp_ops" ASC NULLS LAST
    );
...
-- ----------------------------
CREATE INDEX IF NOT EXISTS "logic_suggestion_status_create_date_index" ON "public"."logic_yjfk_suggestion_status" USING btree (
    "create_date" "pg_catalog"."timestamp_ops" ASC NULLS LAST
    );
