package com.starmol.logicreview;
...
@EnableAsync
@EnableScheduling
@EnableFeignClients(basePackages = {"com.starmol.logicreview.service"})
@SpringBootApplication(scanBasePackages = "com.starmol.logicreview")
@ComponentScan(value = {"com.starmol.logicreview"}, nameGenerator = FullyQualifiedAnnotationBeanNameGenerator.class)
@MapperScan(basePackages = {"com.starmol.logicreview.repository"})
