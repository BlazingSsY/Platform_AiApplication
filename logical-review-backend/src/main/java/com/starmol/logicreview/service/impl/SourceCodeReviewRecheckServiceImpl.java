...
import com.starmol.logicreview.bean.bo.CodeReCheckFileResultBO;
import com.starmol.logicreview.bean.bo.CodeRecheckCodeResultBO;
import com.starmol.logicreview.bean.bo.CodeRecheckResultBO;
import com.starmol.logicreview.bean.bo.CodeReviewRecheckBO;
import com.starmol.logicreview.bean.bo.CodeReviewRecheckRecoderBO;
import com.starmol.logicreview.bean.bo.CodeReviewRecheckListRequestBO;
import com.starmol.logicreview.bean.bo.CodeReviewRecheckResultBO;
import com.starmol.logicreview.bean.bo.CodeReviewRecheckResultSubmitBO;
...
import com.starmol.logicreview.bean.vo.CodeRecheckDetailCodesVO;
import com.starmol.logicreview.bean.vo.CodeRecheckDetailVO;
import com.starmol.logicreview.bean.vo.LoginNameDepartmentVO;
...
import com.starmol.logicreview.model.User;
...
import com.starmol.logicreview.service.SourceCodeReviewRecheckService;
...
public class SourceCodeReviewRecheckServiceImpl implements SourceCodeReviewRecheckService {
    ...
    public IPage<SourceCodeFileAuditVO> getCodeRecheckList(Long pageNumber, Long pageSize, String fileName, Long depId, Long userId, Integer status) {
        ...
        //从ljsc_file_version表中获取file_origin_name like fileName的记录
        SourceCodeFileVersionService sourceCodeFileVersionService = SpringContextUtils.getInstanceByType(SourceCodeFileVersionService.class);
