package com.starmol.sso.server.pojo.dto.param.resolve;
...
public class OauthFormParamArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter methodParameter, ModelAndViewContainer modelAndViewContainer, NativeWebRequest nativeWebRequest, WebDataBinderFactory webDataBinderFactory) {
        ...
        param.setCaptcha(nativeWebRequest.getParameter("captcha"));
        ...
        param.setBoolIsUpdatePwd(Boolean.parseBoolean(nativeWebRequest.getParameter("bool_is_update_pwd")));
        param.setOldPassword(nativeWebRequest.getParameter("old_password"));
        return param;
    }
